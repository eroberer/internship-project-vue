  ...
  <div class="animated fadeIn">
    <b-row>
      <b-col md="12">
        <b-card>
          <div slot="header">
            <strong>Öğretim Görevlileri</strong>
          ...
          <b-modal v-model="addModalShow" @ok="addStudent" size="lg"  title="Yeni Öğretmen Ekle">
...
export default {
  ...
  data() {
    return {
      ...
      departments: [],
      fields: ["Ad Soyad", "Eposta", "Şifre", "Telefon", "İşlem"],
      items: []
    };
  },
  ...
  methods: {
    ...
    addStudent() {
      ...
      const url = "http://bitirme.emre.pw/Okul/OgretmenEkle";
    ...
    updateStudent() {
      ...
      const url = "http://bitirme.emre.pw/Okul/OgretmenDuzenle";
    ...
    deleteStudent(studentId) {
      if (confirm("Silmek istediğinize emin misiniz?")) {
        const url = "http://bitirme.emre.pw/Okul/OgretmenSil";
